...
def test_DecomonDense_1D_box(n, activation, n_subgrad):
    ...
    monotonic_dense = DecomonDense(1, use_bias=True, activation=activation, dc_decomp=True, n_subgrad=n_subgrad)
...
def test_DecomonDense_1D_to_monotonic_box(n, activation, n_subgrad):
    ...
    monotonic_dense = to_monotonic(dense_ref, (2, input_dim), dc_decomp=True, n_subgrad=n_subgrad)
...
def test_DecomonDense_1D_box_nodc(n, activation, n_subgrad):
    ...
    monotonic_dense = DecomonDense(1, use_bias=True, activation=activation, dc_decomp=False, n_subgrad=n_subgrad)
    ref_dense = Dense(1, use_bias=True, activation=activation)
