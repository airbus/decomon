...
from decomon.layers.activations import sigmoid, tanh, softsign
...
def test_sigmoid_multiD_box(odd):
    ...
    assert_output_properties_box_nodc(
        x_0, y_, z_[:, 0], z_[:, 1], u_c_, w_u_, b_u_, l_c_, w_l_, b_l_, "sigmoid_multi_{}".format(odd)
    )
...
def test_tanh_multiD_box(odd):
    ...
    assert_output_properties_box_nodc(
        x_0, y_, z_[:, 0], z_[:, 1], u_c_, w_u_, b_u_, l_c_, w_l_, b_l_, "sigmoid_multi_{}".format(odd), decimal=4
    )
