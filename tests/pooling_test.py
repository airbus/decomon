...
from . import get_tensor_decomposition_1d_box, get_standart_values_1d_box, assert_output_properties_box, get_tensor_decomposition_multid_box, get_standard_values_multid_box, get_tensor_decomposition_images_box, get_standard_values_images_box
...
def test_MaxPooling2D_to_monotonic(data_format, odd, m_0, m_1):
    ...
    assert_output_properties_box(x, y_, h_, g_, z_[:,0], z_[:,1], u_c_, w_u_, b_u_, l_c_, w_l_, b_l_, 'maxpooling_{}'.format(odd))
