...
from tensorflow.keras.layers import Dense, Dropout, Lambda, Permute, Reshape, Concatenate
...
from decomon.backward_layers.crown import Fuse, Convert_2_backward_mode, MergeWithPrevious, Convert_2_mode
...
def crown_(
   ...
   **kwargs,
   ...
   if merge_layers is None:
       ...
       #merge_layers = MergeWithPrevious()
       merge_layers = None
